...
{ 
        ...
        if(Init::checkHeader($request)) {
            ...
            if($validate == "") {
                ...
                if($satker != "[]") {
                    ...
                    foreach($temp as $row) {
                        $list[] = array(
                            "text_in"  => (($row->info_text_in == null? "":strip_tags($row->info_text_in))),
                            "text_en"  => (($row->info_text_en == null? "":strip_tags($row->info_text_en))),
                        );
                    }
        ...
        if(Init::checkHeader($request)) {
            ...
            if($validate == "") {
                ...
                if($satker != "[]") {
                    ...
                    foreach($temp as $row) {
                        $list[] = array(
                            "text_in"  => (($row->story_text_in == null? "":strip_tags($row->story_text_in))),
                            "text_en"  => (($row->story_text_en == null? "":strip_tags($row->story_text_en))),
                        );
                    }
        ...
        if(Init::checkHeader($request)) {
            ...
            if($validate == "") {
                ...
                if($satker != "[]") {
                    ...
                    foreach($temp as $row) {
                        $list[] = array(
                            "text_in"  => (($row->doctrin_text_in == null? "":strip_tags($row->doctrin_text_in))),
                            "text_en"  => (($row->doctrin_text_en == null? "":strip_tags($row->doctrin_text_en))),
                        );
                    }
        ...
        if(Init::checkHeader($request)) {
            ...
            if($validate == "") {
                ...
                if($satker != "[]") {
                    ...
                    foreach($temp as $row) {
                        $list[] = array(
                            "text_in"  => (($row->logo_text_in == null? "":strip_tags($row->logo_text_in))),
                            "text_en"  => (($row->logo_text_en == null? "":strip_tags($row->logo_text_en))),
                        );
                    }
        ...
        if(Init::checkHeader($request)) {
            ...
            if($validate == "") {
                ...
                if($satker != "[]") {
                    ...
                    foreach($temp as $row) {
                        $list[] = array(
                            "text_in"  => (($row->iad_text_in == null? "":strip_tags($row->iad_text_in))),
                            "text_en"  => (($row->iad_text_en == null? "":strip_tags($row->iad_text_en))),
                        );
                    }
        ...
        if(Init::checkHeader($request)) {
            ...
            if($validate == "") {
                ...
                if($satker != "[]") {
                    ...
                    foreach($temp as $row) {
                        $list[] = array(
                            "text_in"  => (($row->intro_text_in == null? "":strip_tags($row->intro_text_in))),
                            "text_en"  => (($row->intro_text_en == null? "":strip_tags($row->intro_text_en))),
                        );
                    }
        ...
        if(Init::checkHeader($request)) {
            ...
            if($validate == "") {
                ...
                if($satker != "[]") {
                    ...
                    foreach($temp as $row) {
                        $list[] = array(
                            "text_in"  => (($row->vision_text_in == null? "":strip_tags($row->vision_text_in))),
                            "text_en"  => (($row->vision_text_en == null? "":strip_tags($row->vision_text_en))),
                        );
                    }
        ...
        if(Init::checkHeader($request)) {
            ...
            if($validate == "") {
                ...
                if($satker != "[]") {
                    ...
                    foreach($temp as $row) {
                        $list[] = array(
                            "text_in"  => (($row->mision_text_in == null? "":strip_tags($row->mision_text_in))),
                            "text_en"  => (($row->mision_text_en == null? "":strip_tags($row->mision_text_en))),
                        );
                    }
        ...
        if(Init::checkHeader($request)) {
            ...
            if($validate == "") {
                ...
                if($satker != "[]") {
                    ...
                    foreach($temp as $row) {
                        $list[] = array(
                            "text_in"  => (($row->program_text_in == null? "":strip_tags($row->program_text_in))),
                            "text_en"  => (($row->program_text_en == null? "":strip_tags($row->program_text_en))),
                        );
                    }
        ...
        if(Init::checkHeader($request)) {
            ...
            if($validate == "") {
                ...
                if($satker != "[]") {
                    ...
                    foreach($temp as $row) {
                        $list[] = array(
                            "text_in"  => (($row->command_text_in == null? "":strip_tags($row->command_text_in))),
                            "text_en"  => (($row->command_text_en == null? "":strip_tags($row->command_text_en))),
                        );
                    }
        ...
        if(Init::checkHeader($request)) {
            ...
            if($validate == "") {
                ...
                if($satker != "[]") {
                    ...
                    foreach($temp as $row) {
                        $list[] = array(
                            "text_in"  => (($row->legal_text_in == null? "":strip_tags($row->legal_text_in))),
                            "text_en"  => (($row->legal_text_en == null? "":strip_tags($row->legal_text_en))),
                        );
                    }
        ...
        if(Init::checkHeader($request)) {
            ...
            if($validate == "") {
                ...
                if($satker != "[]") {
                    ...
                    foreach($temp as $row) {
                        $list[] = array(
                            "text_in"  => (($row->mechanism_text_in == null? "":strip_tags($row->mechanism_text_in))),
                            "text_en"  => (($row->mechanism_text_en == null? "":strip_tags($row->mechanism_text_en))),
                        );
                    }
        ...
        if(Init::checkHeader($request)) {
            ...
            if($validate == "") {
                ...
                if($satker != "[]") {
                    ...
                    foreach($temp as $row) {
                        $list[] = array(
                            "text_in"  => (($row->arrangement_text_in == null? "":strip_tags($row->arrangement_text_in))),
                            "text_en"  => (($row->arrangement_text_en == null? "":strip_tags($row->arrangement_text_en))),
                        );
                    }
        ...
        if(Init::checkHeader($request)) {
            ...
            if($validate == "") {
                ...
                if($satker != "[]") {
                    ...
                    foreach($temp as $row) {
                        $list[] = array(
                            "text_in"  => (($row->accountability_text_in == null? "":strip_tags($row->accountability_text_in))),
                            "text_en"  => (($row->accountability_text_en == null? "":strip_tags($row->accountability_text_en))),
                        );
                    }
        ...
        if(Init::checkHeader($request)) {
            ...
            if($validate == "") {
                ...
                if($satker != "[]") {
                    ...
                    foreach($temp as $row) {
                        $list[] = array(
                            "text_in"  => (($row->professionalism_text_in == null? "":strip_tags($row->professionalism_text_in))),
                            "text_en"  => (($row->professionalism_text_en == null? "":strip_tags($row->professionalism_text_en))),
                        );
                    }
        ...
        if(Init::checkHeader($request)) {
            ...
            if($validate == "") {
                ...
                if($satker != "[]") {
                    ...
                    foreach($temp as $row) {
                        $list[] = array(
                            "text_in"  => (($row->innovation_text_in == null? "":strip_tags($row->innovation_text_in))),
                            "text_en"  => (($row->innovation_text_en == null? "":strip_tags($row->innovation_text_en))),
                        );
                    }
        ...
        if(Init::checkHeader($request)) {
            ...
            if($validate == "") {
                ...
                if($satker != "[]") {
                    ...
                    foreach($temp as $row) {
                        $list[] = array(
                            "text_in"  => (($row->supervision_text_in == null? "":strip_tags($row->supervision_text_in))),
                            "text_en"  => (($row->supervision_text_en == null? "":strip_tags($row->supervision_text_en))),
                        );
                    }
                ...
                if($satker != "[]") {
                    ...
                    foreach($temp as $row) {
                        ...
                        $list[] = array(
                            ...
                            "text_in"  => (($row->unit_text_in == null? "":strip_tags($row->unit_text_in))),
                            "text_en"  => (($row->unit_text_en == null? "":strip_tags($row->unit_text_en))),
                            "url"      => $url,
                        );
                    }
                ...
                if($satker != "[]") {
                    ...
                    foreach($temp as $row) {
                        ...
                        $list[] = array(
                            ...
                            "text_in"        => (($row->news_text_in == null? "":strip_tags($row->news_text_in))),
                            "text_en"        => (($row->news_text_en == null? "":strip_tags($row->news_text_en))),
                ...
                if($satker != "[]") {
                    ...
                    foreach($temp as $row) {
                        ...
                        $list[] = array(
                            ...
                            "text_in"    => (($row->announcement_text_in == null? "":strip_tags($row->announcement_text_in))),
                            "text_en"    => (($row->announcement_text_en == null? "":strip_tags($row->announcement_text_en))),
                ...
                if($satker != "[]") {
                    ...
                    foreach($temp as $row) {
                        ...
                        $list[] = array(
                            ...
                            "text_in"    => (($row->event_text_in == null? "":strip_tags($row->event_text_in))),
                            "text_en"    => (($row->event_text_en == null? "":strip_tags($row->event_text_en))),
                ...
                if($satker != "[]") {
                    ...
                    foreach($temp as $row) {
                        ...
                        $list[] = array(
                            ...
                            "date"     => $date,
                            "time"     => $time,
                            "text_in"  => (($row->content_text_in == null? "":strip_tags($row->content_text_in))),
                            "text_en"  => (($row->content_text_en == null? "":strip_tags($row->content_text_en))),
    ...
    public function menuNavigation(Request $request) {
        ...
        foreach($menus as $row) {
            ...
            $parent[] = array(
                "menu_id"           => $row->menu_id,
                "menu_name"         => Status::htmlCharacters($row->menu_name),
                "menu_label"        => Status::htmlCharacters($row->menu_label),
