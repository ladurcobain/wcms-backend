        ...
        if(Init::checkHeader($request)) {
            ...
            if($validate == "") {
                ...
                if($satker != "[]") {
                    ...
                    $temp = DB::table('tp_photo')->where('satker_id', $satker_id)->where('photo_status', 1)->take($limit)->skip($offset)->get();
                    foreach($temp as $row) {
                        $list[] = array(
        ...
        if(Init::checkHeader($request)) {
            ...
            if($validate == "") {
                ...
                if($satker != "[]") {
                    ...
                    $news = array();
                    $article = DB::table('tp_news')->where('satker_id', $satker_id)->where('news_status', 1)->limit(4)->orderBy('news_date', 'DESC')->get();
